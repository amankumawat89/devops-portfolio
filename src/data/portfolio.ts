...
export const projects: Project[] = [
  ...
  },
  {
    ...
    github: '',
    screenshot: `${base}images/k8s-analyzer/Screenshot 2026-05-20 143241.png`,
    screenshots: [
      `${base}images/k8s-analyzer/Screenshot 2026-05-20 120957.png`,
      `${base}images/k8s-analyzer/Screenshot 2026-05-20 121035.png`,
      `${base}images/k8s-analyzer/Screenshot 2026-05-20 121107.png`,
      `${base}images/k8s-analyzer/Screenshot 2026-05-20 121216.png`,
      `${base}images/k8s-analyzer/Screenshot 2026-05-20 121331.png`,
      `${base}images/k8s-analyzer/Screenshot 2026-05-20 121400.png`,
      `${base}images/k8s-analyzer/Screenshot 2026-05-20 121414.png`,
      `${base}images/k8s-analyzer/Screenshot 2026-05-20 121530.png`,
      `${base}images/k8s-analyzer/Screenshot 2026-05-20 143241.png`,
      `${base}images/k8s-analyzer/Screenshot 2026-05-20 143357.png`,
      `${base}images/k8s-analyzer/Screenshot 2026-05-20 143427.png`,
      `${base}images/k8s-analyzer/Screenshot 2026-05-20 143521.png`,
      `${base}images/k8s-analyzer/Screenshot 2026-05-20 143905.png`,
      `${base}images/k8s-analyzer/Screenshot 2026-05-20 143920.png`,
    ],
    featured: false,
  },
  {
    ...
    github: '',
    screenshot: `${base}images/jenkins-deployment/Screenshot 2026-05-20 122829.png`,
    screenshots: [
      `${base}images/jenkins-deployment/Screenshot 2026-05-20 122829.png`,
      `${base}images/jenkins-deployment/Screenshot 2026-05-20 122901.png`,
      `${base}images/jenkins-deployment/Screenshot 2026-05-20 122909.png`,
    ],
    featured: false,
  },
  {
    ...
    github: '',
    screenshot: `${base}images/website-hosting/Screenshot 2026-05-20 122124.png`,
    screenshots: [
      `${base}images/website-hosting/Screenshot 2026-05-20 122124.png`,
      `${base}images/website-hosting/Screenshot 2026-05-20 122235.png`,
    ],
    featured: false,
  },
];
